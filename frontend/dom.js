...
export const elements = {
  ...
  searchCriteria: byId("searchCriteria"),
  searchCriteriaMovie: byId("searchCriteriaMovie"),
  searchCriteriaDetails: byId("searchCriteriaDetails"),
  searchCriteriaDismiss: byId("searchCriteriaDismiss"),
